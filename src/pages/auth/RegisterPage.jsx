...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="relative w-full lg:w-1/2 flex flex-col items-center justify-center px-8 py-8">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              <div className="relative flex items-center">
                <span className="absolute left-4">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-5 h-5 ${errors.first_name ? 'text-red-500' : 'text-gray-400'}`}>
                ...
                <input
                  ...
                  className={`
                    w-full border rounded-md pl-12 pr-4 py-3 outline-none text-sm
                    ${errors.first_name ? 'border-red-500 text-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-red-500'}
                  `}
            ...
            <div>
              <div className="relative flex items-center">
                <span className="absolute left-4">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-5 h-5 ${errors.last_name ? 'text-red-500' : 'text-gray-400'}`}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                  </svg>
                </span>
                <input
                  ...
                  className={`
                    w-full border rounded-md pl-12 pr-4 py-3 outline-none text-sm
                    ${errors.last_name ? 'border-red-500 text-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-red-500'}
                  `}
            ...
            <div>
              <div className="relative flex items-center">
                <span className="absolute left-4">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-5 h-5 ${errors.confirm_password ? 'text-red-500' : 'text-gray-400'}`}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                  </svg>
                </span>
                <input
                  ...
                  className={`
                    w-full border rounded-md pl-12 pr-12 py-3 outline-none text-sm
                    ${errors.confirm_password ? 'border-red-500 text-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-red-500'}
                  `}
        ...
        {showErrorAlert && (
          <div className="absolute bottom-8 left-8 right-8 lg:left-24 lg:right-24 bg-red-50 text-red-500 px-4 py-3 rounded-md flex justify-between items-center text-sm shadow-sm border border-red-100">
            <span>{message || 'Registrasi gagal'}</span>
